        ...
        <div class="w-[500px] flex flex-col gap-[30px]">
            ...
            <section id="card"
                ...
                <div class="flex items-center justify-center rounded-[14px] overflow-hidden w-[180px] h-[130px]">
                    <img src="assets/images/thumbnails/succes-checkout.png" alt="image"
                        class="object-cover w-full h-full" />
                </div>
                <div class="flex flex-col gap-[10px]">
                    <h2 class="font-bold">
                        Subscription Active: <br />
                        Pro Talent Digital Era 2025
                    </h2>
                    <div class="flex items-center gap-[6px]">
                        <img src="assets/images/icons/calendar-green.svg" alt="icon" class="size-[20px] shrink-0" />
                        <p class="text-obito-text-secondary text-sm leading-[21px]">3 Months Access</p>
                    </div>
                    <div class="flex items-center gap-[6px]">
                        <img src="assets/images/icons/briefcase-green.svg" alt="icon" class="size-[20px] shrink-0" />
                        <p class="text-obito-text-secondary text-sm leading-[21px]">Job-Ready Skills</p>
                    </div>
                </div>
                <img src="assets/images/icons/cup-green-fill.svg" alt="icon"
