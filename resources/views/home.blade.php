            ...
            <div class="flex flex-col gap-[30px]">
                ...
                <div class="flex items-center gap-[18px]">
                    ...
                    <a href="#" class="flex items-center rounded-full h-[67px] border border-obito-grey py-5 px-[30px] bg-white gap-[10px] hover:border-obito-green transition-all duration-300">
                        <img src="{{ asset('app/assets/images/icons/play-circle-fill.svg') }}" class="flex size-8 shrink-0" alt="icon">
                        <span class="text-lg font-semibold">How It Works</span>
                    </a>
                </div>
            </div>
            <div class="flex items-center gap-[14px]">
                <img src="{{ asset('app/assets/images/photos/group.png') }}" class="flex shrink-0 h-[50px]" alt="group photo">
                <div>
                    <div class="flex gap-1 items-center">
                        <div class="flex">
                            <img src="{{ asset('app/assets/images/icons/Star 1.svg') }}" class="flex w-5 shrink-0" alt="star">
                            <img src="{{ asset('app/assets/images/icons/Star 1.svg') }}" class="flex w-5 shrink-0" alt="star">
                            <img src="{{ asset('app/assets/images/icons/Star 1.svg') }}" class="flex w-5 shrink-0" alt="star">
                            <img src="{{ asset('app/assets/images/icons/Star 1.svg') }}" class="flex w-5 shrink-0" alt="star">
                            <img src="{{ asset('app/assets/images/icons/Star 1.svg') }}" class="flex w-5 shrink-0" alt="star">
