...
@section('content')
    <div class="flex relative justify-center">
        <div id="backgroundImage" class="absolute top-0 right-0 left-0">
            <img src="{{ asset('app/assets/images/backgrounds/learning-finished.png') }}" alt="image"
        ...
        <main
            ...
            <div id="card"
                ...
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex items-center gap-[6px]">
                        <img src="{{ asset('app/assets/images/icons/menu-board-green.svg') }}" alt="icon"
                            class="size-5 shrink-0" />
                        <p class="text-sm leading-[21px] text-obito-text-secondary">{{ $course->total_course_section }}
                            Chapter {{ $course->total_section_content }} from
                            Lessons</p>
                    </div>
                </div>
            </div>
