    ...
    <main class="flex flex-col gap-[30px] pb-10 mt-[30px]">
        <header
            ...
            <div id="thumbnail-container"
                ...
                <img src="{{ asset('storage/' . $course->thumbnail) }}" class="w-full h-full object-cover" alt="thumbnail">
                <p
            ...
            <div id="course-info" class="flex flex-col justify-center gap-[30px]">
                <div class="flex flex-col gap-[10px]">
                    <p id="badge"
                        ...
                        <img src="{{ asset('app/assets/images/icons/cup-white.svg') }}" class="w-5 flex shrink-0"
                            alt="icon">
                ...
                <div class="flex flex-col gap-4">
                    <div class="flex gap-4 items-center">
                        <p class="flex items-center gap-[6px]">
                            <img src="{{ asset('app/assets/images/icons/crown-green.svg') }}" class="w-6 flex shrink-0"
                                alt="icon">
                            <span class="font-semibold text-sm leading-[21px]">{{ $course->category->name }}</span>
                        </p>
                        <p class="flex items-center gap-[6px]">
                            <img src="{{ asset('app/assets/images/icons/menu-board-green.svg') }}" class="w-6 flex shrink-0"
                                alt="icon">
                    ...
                    <div class="flex gap-4 items-center">
                        <p class="flex items-center gap-[6px]">
                            <img src="{{ asset('app/assets/images/icons/briefcase-green.svg') }}" class="w-6 flex shrink-0"
                                alt="icon">
                ...
                <div id="tabs-content-container">
                        ...
                        <div id="what-you-learn" class="flex flex-col gap-4">
                            ...
                            <div class="grid grid-cols-2 gap-x-[30px] gap-y-4 w-full max-w-[700px]">
                                <div class="flex items-center gap-3">
                                    ...
                                    <p>Laravel 11 adalah framework PHP yang menjadi favorit para developer</p>
                                </div>
                                <div class="flex items-center gap-3">
                                    <img src="{{ asset('app/assets/images/icons/tick-circle-green-fill.svg') }}"
                                        class="w-6 flex shrink-0" alt="icon">
                        ...
                        @foreach ($course->courseSections as $courseSection)
                            <div
                                ...
                                <button type="button" id="accordion-btn" data-expand="WarmingUp"
                                    ...
                                    <p class="font-semibold text-lg">{{ $courseSection->name }}</p>
                                    <img src="{{ asset('app/assets/images/icons/arrow-circle-down.svg') }}"
                                        alt="icon" class="size-6 shrink-0 transition-all duration-300 -rotate-180" />
                                </button>
                    ...
                    <div id="testimonials-content" class="tab-content grid grid-cols-2 w-full max-w-[860px] gap-5 hidden">
                        <div
                            ...
                            <div class="flex items-center">
                                <img src="{{ asset('app/assets/images/icons/Star 1.svg') }}" class="w-5 flex shrink-0"
                                    alt="icon">
                                <img src="{{ asset('app/assets/images/icons/Star 1.svg') }}" class="w-5 flex shrink-0"
                                    alt="icon">
                                <img src="{{ asset('app/assets/images/icons/Star 1.svg') }}" class="w-5 flex shrink-0"
